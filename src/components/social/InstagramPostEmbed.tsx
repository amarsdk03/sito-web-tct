export default function InstagramPostEmbed({ link, withCaption = false }: { link: string; withCaption?: boolean }) {
    // noinspection JSUnresolvedLibraryURL
    return (
        <>
            <blockquote
                className="instagram-media"
                {...(withCaption && { 'data-instgrm-captioned': '' })}
                data-instgrm-permalink={`https://www.instagram.com/p/${link}/?utm_source=ig_embed&amp;utm_campaign=loading`}
            ...
            >
                <div style={{ padding: '16px' }}>
                    <a
                        href={`https://www.instagram.com/p/${link}/?utm_source=ig_embed&amp;utm_campaign=loading`}
                        style={{
                            background: '#FFFFFF',
                            lineHeight: 0,
                            padding: 0,
                    ...
                    >
                        ...
                        <div style={{ display: 'block', height: '50px', margin: '0 auto 12px', width: '50px' }}>
                            <svg width="50px" height="50px" viewBox="0 0 60 60" version="1.1"
                                 xmlns="https://www.w3.org/2000/svg" xmlnsXlink="https://www.w3.org/1999/xlink">
                    ...
                    <p style={{ color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: '14px', lineHeight: '17px', marginBottom: 0, marginTop: '8px', overflow: 'hidden', padding: '8px 0 7px', textAlign: 'center', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                        <a href={`https://www.instagram.com/p/${link}/?utm_source=ig_embed&amp;utm_campaign=loading`}
                           ...
                           target="_blank">
                            Un post condiviso da Torneo Città di Trento (@torneocittaditrento)
                        </a>
                    </p>
                </div>
            </blockquote>
